...
public:
  SubscribeAndPublish()
  {
    ...
    vins_sub_ = n_.subscribe("/baroness/vins_node/odometry", 1, &SubscribeAndPublish::vins_callback, this);
    gt_sub_ = n_.subscribe("/baroness/odometry_sensor1/odometry", 1, &SubscribeAndPublish::gt_callback, this);
    imu_sub_ = n_.subscribe("/baroness/imu", 1, &SubscribeAndPublish::imu_callback, this);
  }
